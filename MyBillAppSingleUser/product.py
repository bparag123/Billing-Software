...
##================================================buttons frame============================================================
        ...
        ubutton.place(x=50, y=10, width=150, height=30)
        mnbutton = Button(f2, text="PRODUCT MANAGMENT", bg=bgclr2, font=('arial', 15, 'bold'),command=self.u_price,bd=5)
        mnbutton.place(x=300, y=10,width=300, height=30)
        lobutton = Button(f2, text="BACK", bg=bgclr2, font=('arial', 15, 'bold'),command=self.l_out,bd=5)
        lobutton.place(x=700, y=10, width=150, height=30)
